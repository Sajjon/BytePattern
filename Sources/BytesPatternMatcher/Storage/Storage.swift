...
/// Storage for bytes pattern matcher algorithm. Primarily integer groups are stored which
...
/// simultaneously, i.e. the BytesPatternMatcher ought to look at the most signigicant and
